# Access the collaborator code

A collaborator code is a 4-digit code that allows our support team to send an invite to access your store so that we can perform easier debugging or fix theme bugs.
