...
<div style="background-color: #fff3e0; border-left: 4px solid #ff9800; padding: 12px; margin: 16px 0; color: #1a1a1a;">
  <strong>Important:</strong> Once a section has been deleted, it cannot be recovered. You will need to re-create it. If you want to hide it temporarily, click on the eye icon next to the section name.
</div>
...
<div style="background-color: #e8f5e9; border-left: 4px solid #4caf50; padding: 12px; margin: 16px 0; color: #1a1a1a;">
  <strong>Tip:</strong> Not all sections support blocks. Sections like Hero banner or Featured collection are standalone sections without blocks. Sections like Slideshow or Testimonials support blocks for repeating content.
</div>

## Sections vs Blocks Summary

| Feature | Sections | Blocks |
|---------|----------|--------|
| **What** | Major page components | Repeating elements within sections |
| **Limit** | 25 per page | Varies by section (usually 6-12) |
| **Examples** | Hero, Collection grid, Blog posts | Slideshow slides, Testimonial items, Feature icons |
| **Reordering** | Yes, via drag handle | Yes, via drag handle |
