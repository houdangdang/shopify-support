...
<div style="background-color: #e8f5e9; border-left: 4px solid #4caf50; padding: 12px; margin: 16px 0; color: #1a1a1a;">
  <strong>Tip:</strong> Embrace the theme and the decisions we took for you rather than trying to fight with it. The theme has been optimized based on years of e-commerce experience.
</div>
