...
There are different kinds of updates. You can [learn more about theme updates on Shopify documentation](https://help.shopify.com/en/manual/online-store/themes/managing-themes/updating-themes).
...
You can also [hire a Shopify Expert](https://www.shopify.com/partners/directory) if you prefer to have someone doing it for you.

<div style="background-color: #fff3e0; border-left: 4px solid #ff9800; padding: 12px; margin: 16px 0; color: #1a1a1a;">
  <strong>Important:</strong> The update creates a completely new theme copy. Your current theme remains unchanged and published. This allows you to configure the new version before switching over.
</div>
