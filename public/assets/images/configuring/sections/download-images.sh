...
# Download all images from GirlElements Sections articles
cd /Users/mac/Documents/shopify/shopify-support/assets/images/configuring/sections

# Article IDs for Sections category
articles=(811 813)
