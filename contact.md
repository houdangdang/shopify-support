...
See [Updating Your Theme](/theme-basics/updating-theme) for step-by-step instructions.

### Can I use the theme on multiple stores?
A single license is for one store. See [Licensing](/getting-started/licensing) for details.
