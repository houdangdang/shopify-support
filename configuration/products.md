...
![Product Page Editor](/assets/products/product-page-editor.gif)

<div style="background-color: #fff3e0; border-left: 4px solid #ff9800; padding: 12px; margin: 16px 0;">
  Any changes applied to the Default product template will apply to every product in your store. To create per-product settings, you must use alternate templates. <a href="https://support.maestrooo.com/article/693-alternate-templates">Learn more</a>.
</div>


To configure product page content, click on the **"Add block"** button in the "Product page" section:

![Product add block](/assets/products/product-add-block.gif)
...
**Note:** Please note that not all apps integrate with this. Other popular reviews apps such as Loox or Yotpo are using their own, proprietary system. If you are using one of those apps and would like to show rating on product listings, please reach the app developer.

To enable rating on listing pages, follow the steps shown below.

### Showing reviews on product pages
To show reviews on your product page, open the theme editor and navigate to the product page. In the "Product page" section, click on "Product meta" and select "Show product rating". Re-order the block to your desired position.

![Product show reviews](/assets/products/product-show-reviews.gif)
...
![Color Swatch Mapping](/assets/products/color-swatch-mapping.gif)
...
![Color Picker Tips](/assets/products/color-picker-tips.png)
...
![Files Section](/assets/products/files-section.png)
...
![Color Swatch Option Names](/assets/products/color-swatch-option-names.png)
...
![Color Swatch Display](/assets/products/color-swatch-showing-swatches.png)
...
- Can I show variant images instead of swatches? Instead of showing color swatches, you can instead show variant images for colors. [Learn more about this feature](https://support.maestrooo.com/article/767-variant-image-for-color-options).
...
## Custom badges
**Note:** These instructions only work for Stretch, Impact, Prestige version 7 and up, Warehouse version 6 and up, Focal version 12 and up. If you use an older theme version we recommend updating. For Focal and earlier versions of Warehouse [see our guide here](https://support.maestrooo.com/article/801-displaying-a-custom-badge-label-on-collections).
...
![Custom Badges Metafields](/assets/products/custom-badges-metafields.png)
...
![Custom Badges Displaying](/assets/products/custom-badges-displaying.png)
...
<div style="background-color: #e3f2fd; border-left: 4px solid #2196f3; padding: 12px; margin: 16px 0;">
  <strong>Note:</strong> Every theme has a different tab/accordion layout. The tab design in Prestige, Impact, Focal and Warehouse are each unique to the theme.
</div>
...
<div style="background-color: #e3f2fd; border-left: 4px solid #2196f3; padding: 12px; margin: 16px 0;">
  <strong>Important:</strong> The combined listing app is currently limited to Shopify Plus customers. If you would like to use this feature on a non-Plus plan, we recommend you reach out to Shopify support to let them know you are interested in this feature being expanded to non-Plus merchants. You can also use the [product variations feature](https://support.maestrooo.com/article/722-product-variations-linked-products) as an alternative.
</div>

Combined listing is a powerful app that allows showcasing your products that come in multiple colors, materials, or lengths, all from the same product listing. It is the native Shopify solution for the [product variations feature](https://support.maestrooo.com/article/722-product-variations-linked-products) that we offer in our themes, but without many of the drawbacks.
...
<div style="background-color: #e3f2fd; border-left: 4px solid #2196f3; padding: 12px; margin: 16px 0;">
  <strong>Note:</strong> This feature is not supported in Warehouse
</div>
...
![Size Chart Example](/assets/products/size-chart-page.png)
...
![Create Size Chart Page](/assets/products/size-chart-page.png)
...
With this approach, you can select a unique size chart for each product (or a group of products, as the same page can be assigned to more than one product).

<div style="background-color: #e8f5e9; border-left: 4px solid #4caf50; padding: 12px; margin: 16px 0;">
  <strong>Tip:</strong> You can use the bulk editor to assign the same page to multiple products in bulk. [Learn more about bulk editing](https://help.shopify.com/en/manual/custom-data/metafields/bulk-edit-metafields).
</div>
...
**Note:** Currently, the progress bar is only available on the Prestige theme.
...
![Inventory Showing](/assets/products/inventory-showing.png)
...
![Inventory Progress Bar](/assets/products/inventory-progress-bar.png)
...
![Inventory Low Stock](/assets/products/inventory-low-stock.png)
...
To add the related products section, open the theme editor, navigate to the product page, click **"Add section"** and select **"Related products."** The screencast below will guide you through the steps:
...
Hiding sold-out badges through settings is only possible on Impact and Prestige version 7 and higher. If you are using an older version, reach our support directly.
...
To do that, open the theme editor, click on the page selector at the top of the editor, click on "Products" and select "Default template" (or a different template if you wish to apply the change there):
Click on the "Product page" section:
Turn off the "Show sticky add to cart" setting (please note the exact setting name might differ slightly based on the theme you are using):
